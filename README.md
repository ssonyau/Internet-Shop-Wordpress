...
#### 1) Переходимо в розділ під назвою "Вигляд" та обираємо сторінку "Выджети". Тут ми бачим таку річ як "Woocommerce Sidebar". Ми можемо його змінити, вказавши які елементи ми відображаємо в бічній панелі .
