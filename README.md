...
#### 6) Тепер перейдемо на вкладку "Доставка". І тут же ми можемо вказати формат доставки в ту чи іншу країну. Для цього натискаємо на кнопку "Додати зону доставки".
